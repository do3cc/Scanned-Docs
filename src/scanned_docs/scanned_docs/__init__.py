...
def add_base_template(event):
    base = get_renderer('scanned_docs:templates/base.pt'
                        ).implementation()
...
def main(global_config, **settings):
    ...
    config.add_view('scanned_docs.views.maintenance.upgrade',
                    name='upgrade', renderer='json')
    ...
    config.add_view('scanned_docs.views.edit.edit', route_name='edit',
                    ...
                    request_method='GET')
    config.add_view('scanned_docs.views.edit.edit_post',
                    route_name='edit', request_method='POST')
    config.add_static_view('static', 'scanned_docs:static')
    config.add_subscriber(add_base_template,
